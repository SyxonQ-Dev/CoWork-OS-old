...
| GitHub stars | 457 |
| GitHub forks | 79 |
| Installer/server downloads | 1,741 |
| Download delta | +3 |
| npm downloads, last week | 250 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-19T08:06:07.668Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
