...
| GitHub stars | 451 |
| GitHub forks | 78 |
| Installer/server downloads | 1,696 |
| Download delta | +9 |
| npm downloads, last week | 158 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-14T08:59:23.847Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
