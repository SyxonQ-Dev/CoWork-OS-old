...
| GitHub stars | 448 |
| GitHub forks | 74 |
| Installer/server downloads | 1,610 |
| Download delta | +2 |
| npm downloads, last week | 598 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-06T07:56:41.891Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
