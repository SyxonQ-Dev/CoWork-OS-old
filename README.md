...
| GitHub stars | 449 |
| GitHub forks | 76 |
| Installer/server downloads | 1,636 |
| Download delta | +9 |
| npm downloads, last week | 112 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-09T08:11:50.527Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
