...
| GitHub stars | 447 |
| GitHub forks | 75 |
| Installer/server downloads | 1,616 |
| Download delta | +6 |
| npm downloads, last week | 112 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-07T08:22:31.926Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
