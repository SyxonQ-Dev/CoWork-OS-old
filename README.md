...
| GitHub stars | 457 |
| GitHub forks | 79 |
| Installer/server downloads | 1,769 |
| Download delta | +1 |
| npm downloads, last week | 661 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-21T09:00:41.647Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
